...
// const asd = document.querySelector("grid_container_travel")

// const section = document.createElement("article")
// section.classList.add("grid_travel_col_1")
// section.classList.add("flex_item_travel")
// console.log(section)
// section.innerHTML = `
...
// <!--  <a href="https://www.esky.com/?gclid=Cj0KCQiA37KbBhDgARIsAIzce144bzlqBmBOgB-FA-JVXY8oYpPYpL2Bd9KjtGmnCRSQgVhxWE3SilIaAi3_EALw_wcB#info" target="_blank" class="button_travel"> --><!-- <button id="brisbane">
//     <span class="button_top"> Purchase Travel Pack
//     </span>
//     </button> -->
// <!-- </a> --> 
// </div>
...
{/* <section class="grid_container_travel">
                
                <article class="grid_travel_col_1 flex_item_travel" >
                    <div class="travel_img">
                        <img class="zoom_1" src="../image/sydney.jpg" alt="Sydney Opera House">
                        <img  class="zoom_2" src="../image/sydney2.jpg" alt="Travelers enjoying Sydney's views">
                    </div>
